...
export let UrlGetPersyaratanByNIDN = "https://p3-be.ulbi.ac.id/api/sidang/syarat/nidn";
...
export let UrlGetAllPendaftaranI2 = "https://kimteungbim.ulbi.ac.id/i2/pengajuan";
export let UrlSearchPendaftaranI2 = "https://kimteungbim.ulbi.ac.id/i2/mhs/pengajuan";
export let UrlGetSuperRole = "https://kimteungbim.ulbi.ac.id/i2/sudo";
