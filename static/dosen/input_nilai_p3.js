  ...
  function SubmitNilaiBackEndP3() {
    ...
    let data = {
      ...
      assessment_inputs: [
        {
          assess_name:
            "Semua endpoint berfungsi termasuk otorisasi dan autentikasi token",
          assess_weight: 25,
          value: parseInt(inputNilaiBE1),
        },
        {
          assess_name: "Package dibuat sendiri dan semua digunakan",
          assess_weight: 25,
          value: parseInt(inputNilaiBE2),
        },
        {
          assess_name:
            "Semua endpoint di GCF memakai package yang dibuat dan lokasi server di jakarta",
          assess_weight: 25,
          value: parseInt(inputNilaiBE3),
        },
        {
          assess_name: "Terintegrasi dengan wa.my.id",
          assess_weight: 25,
          value: parseInt(inputNilaiBE4),
        },
      ],
    };
  ...
  function SubmitNilaiFrontEndP3() {
    ...
    let data = {
      ...
      assessment_inputs: [
        {
          assess_name:
            "semua js di rilis versi di jsdelivr dari semua js buatan sendiri yang dipakai frontend",
          assess_weight: 25,
          value: parseInt(inputNilaiFE1),
        },
        {
          assess_name:
            "pemanggilan jsdelivr pada html yang sudah pasti pakai type module",
          assess_weight: 25,
          value: parseInt(inputNilaiFE2),
        },
        {
          assess_name:
            "kelengkapan css, favicon, 404.html, modal, transisi, loading, responsive dan hasil analisis dari gtmetrix.com",
          assess_weight: 25,
          value: parseInt(inputNilaiFE3),
        },
        {
          assess_name: "memakai custom domain pada github pages nya.",
          assess_weight: 25,
          value: parseInt(inputNilaiFE4),
        },
      ],
    };
